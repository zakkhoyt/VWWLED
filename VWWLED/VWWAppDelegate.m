...
#import "VWWImagePickerWindowController.h"
...
@property (strong) VWWImagePickerWindowController *imagePickerWindowController;
...
{
//    self.imagePickerWindowController = [[VWWImagePickerWindowController alloc]initWithWindowNibName:@"VWWImagePickerWindowController" owner:self];
//    [self.imagePickerWindowController showWindow:self];
//    self.statusTextField.stringValue = @"Use the open button to select an image (16x16)";
...
//            
//            
//            self.imageWell.image = [[NSImage alloc]initWithContentsOfURL:fileURL];
//            
//            
